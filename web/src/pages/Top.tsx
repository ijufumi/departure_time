  ...
  return (
    <Container sx={{ bgcolor: "#f5f5f5", display: "flex", justifyContent: "center", alignItems: "center", minHeight: "100vh", minWidth: "100vw"}}>
      <Box sx={{ bgcolor: "#ffffff", borderRadius: "10px" }} width={"600px"} height={"500px"}>
        <Snackbar open={successSnackBarOpen} onClick={() => setSuccessSnackBarOpen(false)} onClose={() => setSuccessSnackBarOpen(false)} autoHideDuration={1000}>
          <Alert severity="success" variant="filled">Sending message was successful</Alert>
        </Snackbar>
        <Snackbar open={errorSnackBarOpen} onClick={() => setErrorSnackBarOpen(false)} onClose={() => setErrorSnackBarOpen(false)} autoHideDuration={1000}>
